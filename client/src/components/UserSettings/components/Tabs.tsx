...
import {
  ...
  TabFieldContainer,
  Title,
} from './styled-components/Tabs.styled';
...
import {
  ButtonLog,
  TwoFields,
} from '../../singup/styled-components/SingUp.styled';
...
export default function Tabs({ closeModal }: { closeModal: Function }) {
  ...
  function handleChangeView2(
    event: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>
  ) {
    setMail(event.target.value);
    if (!event.target.value) setErrorView2('Mail is empty!');
  ...
  async function handleSubmitView2() {
    if (!mail) setErrorView2('Mail is empty');
    else {
      try {
  ...
  function handleChangeCurrentPassword(
    ...
    if (!event.target.value) setCurrentPasswordError('Password is empty!');
  ...
  function handleChangeNewPassword(
    ...
    if (!event.target.value) setNewPasswordError('New password is empty!');
  ...
  async function handleSubmitView3() {
    if (!currentPassword) setCurrentPasswordError('Password is empty!');

    if (!newPassword) setNewPasswordError('New password is empty!');
    else {
      try {
        if (auth.currentUser != null) {
          setBtnLoading(true);
        ...
        <Box display='flex' flexDirection='row'>
          ...
          <Box width='500px' height='400px'>
            <TabView
              ...
              subtitle={'Configuración de su información personal'}
              content={
            ...
            <TabView
              ...
              subtitle={'Cambia tu correo con una confirmación.'}
              content={
                <div
                  style={{
                    width: '100%',
                ...
                >
                  ...
                  >
                    <TextField
                      ...
                      helperText={
                        errorView2 && (
                          <span style={{ fontSize: '13px' }}>{errorView2}</span>
                        )
                      }
                      sx={{
                        position: 'relative',
            ...
            <TabView
              ...
              subtitle='Aquí podrá cambiar su contraseña'
              content={
                <div style={{ width: '100%', height: '100%', padding: '40px' }}>
                  <TwoFields>
                    <TextField
